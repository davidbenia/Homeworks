...
public class Task7 implements Task7_Interface{
    ...
    public void AddElements(boolean command) {
        if(!command)
            ...
            linked_list.add(n, rand.nextInt(100)); //nextInt upper bound 100 for better readability;
        }
    }
    ...
    public void PrintElements() {
        ...
        System.out.format("T7 Elements original: %s\n\n",
        ...
        System.out.format("T7 Elements new: %s\n\n",
                print_me.substring(0, print_me.length() - 2));
    }
}
